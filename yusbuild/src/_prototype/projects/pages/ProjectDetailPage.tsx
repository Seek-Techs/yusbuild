...
import { findProject, formatKg, formatM3, pilesForProject } from "../../data";
        ...
        actions={
          <>
            <Button asChild variant="outline">
              <Link to={`/_prototype/projects/${project.id}/boq`}>
                <FileText /> BOQ
              </Link>
            </Button>
                  ...
                  {projectPiles.map((pile) => (
                    <TableRow key={pile.id}>
                      ...
                      <TableCell className="text-right">
                        {pile.actualLengthM} m
                      </TableCell>
                      <TableCell className="text-right">
                        {formatKg(pile.steelKg)}
                      </TableCell>
                      <TableCell className="text-right">
                        <Button asChild variant="outline" size="sm">
                          <Link to={`/_prototype/piles/${pile.id}`}>Open</Link>
                        </Button>
                      </TableCell>
                    </TableRow>
                  ))}
