            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="pile-no"
                    defaultValue="LCB-B-P037"
                    placeholder="LCB-B-P001"
                  />
                </div>
              ...
              {submitted ? (
                <div className="flex flex-col gap-3 rounded-md border border-success/30 bg-success-muted p-4 sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="mt-0.5 h-5 w-5 text-success" />
                    <div>
                      <p className="font-medium">Pile record saved</p>
                      <p className="text-sm text-muted-foreground">
                        The record is ready for calculation review and BOQ
                        inclusion.
                      </p>
                    </div>
                  </div>
              ...
              <div className="flex flex-wrap justify-end gap-2 border-t pt-4">
                <Button asChild variant="outline" type="button">
                  <Link to="/_prototype/piles">Cancel</Link>
                </Button>
                <Button type="submit">
                  <Save /> Save pile
                </Button>
        ...
        <Card className="rounded-md">
          ...
          <CardContent className="space-y-3 p-4 pt-0 text-sm text-muted-foreground">
            <div className="rounded-md border p-3">
              ...
              <p>
                Project, pile number, type, diameter, and design/actual length.
              </p>
            </div>
            <div className="rounded-md border p-3">
              ...
              <p>
                Steel and concrete quantities are calculated from type,
                diameter, design length, and actual length.
              </p>
            </div>
            <div className="rounded-md border p-3">
              <p className="font-medium text-foreground">Error states</p>
              <p>
                Check duplicate pile numbers, missing type configuration,
                invalid lengths, and read-only access.
              </p>
            </div>
          </CardContent>
        </Card>
