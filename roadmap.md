...
- New: tests/test_calculation_audit.py **Implementation Tasks** 
...
- Add endpoint to view calculation history. **Recommended Patterns** 
...
- API can retrieve calculation history per pile. **Testing Requirements** 
...
- Config changes do not mutate old history. **Branch** 
text
feature/calculation-audit-history
**Commit Format** 
text
...
- .env.example 
- README.md 
- New: config/health.py or apps/common/views.py **Implementation Tasks** 
...
**Immediate Next Move** Start with: 
text
feature/access-control-project-security
