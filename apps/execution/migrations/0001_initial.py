    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "record_type",
                    models.CharField(
                        choices=[("PILE_DRIVING", "Pile Driving")],
                        db_index=True,
                        default="PILE_DRIVING",
                        max_length=40,
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="execution.piledrivingrecord",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="execution_r_project_8261e6_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="executionrecord",
            index=models.Index(
                fields=["pile", "record_type"], name="execution_r_pile_id_2a8279_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="piledrivingrecord",
            index=models.Index(
                fields=["project", "start_time"], name="pile_drivin_project_57afff_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="piledrivingrecord",
            index=models.Index(
                fields=["pile", "start_time"], name="pile_drivin_pile_id_7a9afd_idx"
            ),
        ),
        migrations.AddConstraint(
