        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "helix_pitch_mm",
                    models.PositiveIntegerField(
                        default=250, help_text="Helix pitch/spacing in mm"
                    ),
                ),
                (
                    "cage_diameter_mm",
                    models.PositiveIntegerField(
                        default=480, help_text="Reinforcement cage diameter in mm"
                    ),
                ),
                (
                    "helix_end_turns",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=16, help_text="Stiffener ring bar diameter in mm"
                    ),
                ),
                (
                ...
                (
                    "concrete_cover_mm",
                    models.PositiveIntegerField(
                        default=20, help_text="Concrete cover to reinforcement in mm"
                    ),
                ),
                (
                    "is_active",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "location_on_site",
                    models.CharField(
                        blank=True, help_text="Location on site", max_length=200
                    ),
                ),
                (
                    "drawing_reference",
                    models.CharField(
                        blank=True, help_text="Drawing reference number", max_length=100
                    ),
                ),
                (
                    "date_installed",
                    models.DateField(
                        blank=True, help_text="Date of installation", null=True
                    ),
                ),
                (
                    "notes",
                    models.TextField(
                        blank=True, help_text="Obstructions, remarks, test results"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "main_bars_kg",
                    models.FloatField(
                        default=0.0, help_text="Total main bar weight in kg"
                    ),
                ),
                (
                    "helix_kg",
                    models.FloatField(
                        default=0.0, help_text="Total helix/spiral weight in kg"
                    ),
                ),
                (
                    "stiffeners_kg",
                    models.FloatField(
                        default=0.0, help_text="Total stiffener ring weight in kg"
                    ),
                ),
                (
                    "total_steel_kg",
                    models.FloatField(
                        default=0.0, help_text="Grand total steel weight in kg"
                    ),
                ),
                (
                    "design_concrete_m3",
                    models.FloatField(
                        default=0.0, help_text="Concrete volume using design length"
                    ),
                ),
                (
                    "actual_concrete_m3",
                    models.FloatField(
                        default=0.0, help_text="Concrete volume using actual length"
                    ),
                ),
                (
                    "calculation_version",
